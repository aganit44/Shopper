...
import 'package:hello/Product/NewProduct/Adidas/detail_page.dart';
import 'package:hello/Product/NewProduct/Adidas/detail_page2.dart';
import 'package:hello/Product/NewProduct/Adidas/detail_page3.dart';

class Adidas extends StatefulWidget {
  @override
  _AdidasState createState() => _AdidasState();
}
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Adidas1()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Adidas2()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Adidas3()),
                    );
                  },
                ),
              ],
