...
import 'package:hello/Product/NewProduct/Vans/detail_page.dart';
import 'package:hello/Product/NewProduct/Vans/detail_page2.dart';
import 'package:hello/Product/NewProduct/Vans/detail_page3.dart';

class Vans extends StatefulWidget {
  @override
  _VansState createState() => _VansState();
}

class _VansState extends State<Vans> {
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Vans1()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Vans2()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Vans3()),
                    );
                  },
                ),
              ],
