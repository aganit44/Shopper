...
import 'package:hello/Product/NewProduct/Reebok/detail_page.dart';
import 'package:hello/Product/NewProduct/Reebok/detail_page2.dart';
import 'package:hello/Product/NewProduct/Reebok/detail_page3.dart';

class Reebok extends StatefulWidget {
  @override
  _ReebokState createState() => _ReebokState();
}
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Reebok1()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Reebok2()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Reebok3()),
                    );
                  },
                ),
              ],
