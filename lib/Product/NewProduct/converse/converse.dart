...
import 'banner4.dart';
import 'package:hello/Product/NewProduct/converse/detail_page.dart';
import 'package:hello/Product/NewProduct/converse/detail_page2.dart';
import 'package:hello/Product/NewProduct/converse/detail_page3.dart';

class converse extends StatefulWidget {
  @override
  _converseState createState() => _converseState();
}
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => converse1()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => converse2()),
                    );
                  },
                ),
              ],
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => converse3()),
                    );
                  },
                ),
              ],
